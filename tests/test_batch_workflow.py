...
def test_batch_case_requires_source_location_and_terms():
    case = {
        "case_id": "BQ-1",
        "expected_source_path": "[LOCAL_PATH_REDACTED]",
    ...
    result = {
        ...
        "answer": "结论：建筑：2条。",
        "citations": [{"source_path": "[LOCAL_PATH_REDACTED]", "display_location": "表11，第4-5行", "citation_id": "S1"}],
...
""", location={"page": 3})
    ...
    cases = batch._generate_pdf_cases(Path("[LOCAL_PATH_REDACTED]"))
