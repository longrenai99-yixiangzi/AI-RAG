    ...
    <footer className="answer-actions">
      ...
      <details className="feedback-editor">
        ...
        <form onSubmit={submit}>
          ...
          <label>正确来源文件（可选）<input value={draft.source_path} onChange={(event) => setDraft({ ...draft, source_path: event.target.value })} placeholder="例如：[LOCAL_PATH_REDACTED]��\\文件.pdf" /></label>
