# Scope Guard Test Leakage Cleanup Report
...
- `runtime_hardcoding`：**0**
- `report_only_hardcoding`：5
- `test_assertion_hardcoding`：0
...
- Final Status 分布：`{"GENERATED": 3, "NO_EVIDENCE": 3, "STRUCTURE_INVALID": 2, "PARTIAL_EVIDENCE": 1, "FACT_RESULT": 1}`
...
|---:|---|---|---|---|---:|---|---|
| 1 | Root-001 | 2025年饶淇述职.md | EXACT_SCOPE_MATCH | SCOPE_PROBE | 2.95 | FULL_YEAR | FINAL |
| 2 | Root-001 | 2025年年度总结.md | EXACT_SCOPE_MATCH | SCOPE_PROBE | 2.6 | FULL_YEAR | FORECAST |
| 3 | Root-001 | 2025年任慧军述职.md | EXACT_SCOPE_MATCH | SCOPE_PROBE | 2.3 | FULL_YEAR | FORECAST |
| 4 | Root-001 | 2024年度总结2.md | COMPATIBLE_SCOPE | SCOPE_PROBE | 1.54 | FULL_YEAR | FORECAST |
| 5 | Root-001 | 2025年半年总结.md | COMPATIBLE_SCOPE | SCOPE_PROBE | 1.48 | HALF_YEAR | FORECAST |
| 6 | Root-001 | 2025年设计管理总结.md | COMPATIBLE_SCOPE | SCOPE_PROBE | 1.44 | FULL_YEAR | FORECAST |
| 7 | Root-002 | 关于优化公司总部部门及设置“四大中心”的通知.pdf | COMPATIBLE_SCOPE | SCOPE_PROBE | 1.42 | FULL_YEAR | FORECAST |
...
| 10 | Root-002 | 关于印发中建三局第二建设公司2026年设计与技术（科技）工作计划的通知.pdf | PARTIAL_SCOPE_MATCH | SCOPE_PROBE | 0.64 | FULL_YEAR | FORECAST |
| 11 | Root-001 | 公司公路市政产品线设计创效案例汇编模板（案例示例） - 成果.pptx | PARTIAL_SCOPE_MATCH | SCOPE_PROBE | 0.58 | FULL_YEAR | FINAL |
| 12 | Root-001 | 公司学校产品线设计创效案例汇编模板（案例示例） - 成果.pptx | PARTIAL_SCOPE_MATCH | SCOPE_PROBE | 0.58 | UNKNOWN | FORECAST |
...
[
  {
    "claim_id": "C1",
    "claim_text": "2025年公司设计创效金额约4.45亿元",
    "evidence_ids": [
      "S1"
    ]
  }
...
| BA-006 | ENABLED | NO_EVIDENCE | PARTIAL_EVIDENCE | CLAIM_ANSWER_PATH | True |
...
- 每题 JSON 和动态负向测试保存在 `D:\AI智能体\AI设计管理RAG-V1\evaluation\scope_guard_leakage_cleanup`。
