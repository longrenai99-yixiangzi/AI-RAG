...
def _document(document_id, authority, scope, rank):
    return {"document_id": document_id, "rank": rank, "bm25_rank": rank, "dense_rank": rank, "rrf_score": 0.02, "authority": authority, "scope": scope, "document_type": "PROJECT_PLAN", "source_path": f"[LOCAL_PATH_REDACTED]", "metadata_match": [], "planner_match": {}}


def _section(section_id, document_id, rank):
    return {"section_id": section_id, "document_id": document_id, "rank": rank, "bm25_rank": rank, "dense_rank": rank, "rrf_score": 0.02, "source_path": f"[LOCAL_PATH_REDACTED]", "metadata_match": [], "planner_match": {}}


def _evidence(evidence_id, document_id, section_id, rank):
    return {"evidence_id": evidence_id, "document_id": document_id, "section_id": section_id, "rank": rank, "source_path": f"[LOCAL_PATH_REDACTED]", "file_name": f"{document_id}.xlsx", "text": "value creation rows", "location": {"sheet_name": "Sheet1"}, "candidate_origin": "HIERARCHICAL", "lineage_status": "LINEAGE_NOT_APPLICABLE"}
