...
export type SampleSourceType = '制度' | '指南' | '模板' | '案例' | '清单' | '计划'

export type SampleSource = { id: string; name: string; type: SampleSourceType; authority: '正式' | '参考'; location: string; excerpt: string }
export type SampleKnowledgeCard = { id: string; title: string; summary: string; keyPoints: string[]; sourceIds: string[] }
export type SampleCase = { id: string; name: string; scenario: string; outcome: string; sourceIds: string[] }

export const technicalConstructionNodeId = 'technical-construction-1'

export const technicalConstructionSources: SampleSource[] = [
  { id: 'tos-01', name: '施工组织设计编制管理指引（Mock）', type: '制度', authority: '正式', location: '第 2 章 / 第 4—8 条', excerpt: '总体施工组织设计应在项目实施策划阶段完成编制、评审与动态更新。' },
  { id: 'tos-02', name: '总体施工组织设计编制模板（Mock）', type: '模板', authority: '正式', location: '目录 / 表单 1—9', excerpt: '模板包括工程概况、施工部署、进度计划、资源配置、总平面布置与风险控制。' },
  { id: 'tos-03', name: '总体施工组织设计审查要点清单（Mock）', type: '清单', authority: '正式', location: '审查项 01—24', excerpt: '审查施工部署与合同工期、资源能力、现场条件和重大风险是否匹配。' },
  { id: 'tos-04', name: '施工总进度计划编制要点（Mock）', type: '指南', authority: '正式', location: '第 3 节 / 关键线路', excerpt: '进度计划应明确里程碑、关键线路、资源约束及纠偏机制。' },
  { id: 'tos-05', name: '项目施工部署与现场总平面布置指引（Mock）', type: '指南', authority: '正式', location: '第 2 节 / 场地组织', excerpt: '现场总平面应统筹运输组织、临建设施、材料堆场、机械布置与消防通道。' },
  { id: 'tos-06', name: '项目资源配置计划表（Mock）', type: '模板', authority: '正式', location: '人工 / 材料 / 机械表', excerpt: '资源计划应按阶段匹配劳动力、主要材料、周转料具和机械设备需求。' },
  { id: 'tos-07', name: '产业园项目总体施组编制案例（Mock）', type: '案例', authority: '参考', location: '第 3 章 / 施工部署', excerpt: '案例采用分区、分段、穿插施工组织，并以关键线路控制工期风险。' },
  { id: 'tos-08', name: '总体施组风险与动态纠偏记录（Mock）', type: '计划', authority: '参考', location: '风险台账 / R-01—R-12', excerpt: '对资源供应、雨季施工、交叉作业和场地转换设置预警及纠偏责任人。' },
]

export const technicalConstructionCards: SampleKnowledgeCard[] = [
...
export const technicalConstructionCases: SampleCase[] = [
...
export function getTechnicalConstructionSample(nodeId: string) {
  return nodeId === technicalConstructionNodeId
    ? { graph: technicalConstructionGraph, cards: technicalConstructionCards, sources: technicalConstructionSources, cases: technicalConstructionCases, space: technicalConstructionSpace }
    : undefined
}
