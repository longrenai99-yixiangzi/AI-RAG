...
def test_authority_does_not_override_project_scope():
    ...
    policy = classifier.classify(file_name="设计管理制度.md", source_path="[LOCAL_PATH_REDACTED]", text="项目案例仅适用于星谷项目")
    case = classifier.classify(file_name="星谷项目复盘.md", source_path="[LOCAL_PATH_REDACTED]", text="公司年度复盘")
